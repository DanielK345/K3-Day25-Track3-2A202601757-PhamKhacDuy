...
class ResponseCache:
    ...
    Includes semantic similarity and false-hit guardrails.
    ...
    def set(self, query: str, value: str, metadata: dict[str, str] | None = None) -> None:
        ...
        Storage contract with privacy guardrail:
...
class SharedRedisCache:
    ...
    The get() and set() methods use Redis commands so cache state is shared
